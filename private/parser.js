...
module.exports = {
	// parseWholeFileSync:function(fileName,format,callback){
	// 	try {
	// 		var data = fs.readFileSync(fileName);
	// 		try {
	// 			this.parseBinaryFile(data,format,callback)
	// 		} catch (e){
	...
	// 	}
	// },
	// parseWholeFile:function(fileName,format,callback){
...
var parsePackageData = function(p_data,tail) {
	try {
		...
		console.log("PARSER_ERROR_Packs: "+e);
	}
}

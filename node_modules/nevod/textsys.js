...
module.exports = {
	...
	writeFile:function(file,data){
		fs.writeFile(file,data,function(err){
			if(err){
				console.error("TXTSYS_ERRWR: "+err);
			}
		})
	},
	appendFile:function(file,data){
		fs.appendFile(file,data,function(err){
			if(err){
				console.error("TXTSYS_ERRAPND: "+err);
			}
		})
	},
	appendFileSync:function(file,data){
		try{
			...
			console.error("TXTSYS_ERRAPNDS: "+e);
			return false;
		}
		return true;
	},
	writeSpectrumToFile:function(filename,sp,spLength,sync){
		try{
